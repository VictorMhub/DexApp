...
import { semiArrow, boy, apple, google } from "../assets";
...
const SignIn = () => (
  <section className="flex flex-col sm:py-15 py-5 items-center">
    ...
    <img className="py-6 w-[266px]" src={boy} alt="" />
    ...
    <div className="flex flex-col items-start py-8">
      ...
      <div className="flex flex-col items-center pt-[25px] gap-[2px] w-full">
        <div
          className="flex items-center flex-row border-2 rounded-full w-[328px] h-[60px]"
        >
